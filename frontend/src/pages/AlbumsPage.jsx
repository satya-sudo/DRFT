...
export default function AlbumsPage() {
  return (
    <AppShell
      title="Albums"
      description="Albums are planned for a later DRFT release. For v0.1.0-rc, the focus stays on a stable timeline, uploads, and viewer experience."
    >
      <div className="placeholder-layout">
        ...
        <article className="surface placeholder-card">
          ...
          <p>
            For `v0.1.0-rc`, we are keeping the release surface tight and prioritizing
